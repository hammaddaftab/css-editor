// Default seed markdown and CSS templates for the editor

export const DEFAULT_MARKDOWN = `# Welcome to CSS Markdown Editor
...
export const DEFAULT_CSS = `/* Custom document CSS — overrides print.css defaults */
