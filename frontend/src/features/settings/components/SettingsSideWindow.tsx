import type { SettingsSideWindowProps } from '../types';
import { useSettingsSideWindow } from '../hooks/useSettingsSideWindow';

export function SettingsSideWindow(props: SettingsSideWindowProps) {
